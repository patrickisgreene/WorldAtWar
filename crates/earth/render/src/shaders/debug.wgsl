#define_import_path waw_earth_render::debug

#import waw_earth_render::types::{Coordinate, WorldCoordinate, TileCoordinate, AtlasTile, Blend}
#import waw_earth_render::bindings::{earth, tile_tree, earth_view, approximate_height, geometry_tiles, attachments, origins}
#import waw_earth_render::functions::{lookup_best, compute_world_coordinate, tree_lod, compute_subdivision_coordinate}
