use crate::math::{
    ...
    NEIGHBOURING_FACES, SIGMA, EarthShape,
};
use bevy::{
    math::{DVec2, DVec3},
    prelude::*,
...
impl Coordinate {
    ...
    pub fn from_local_position(world_position: DVec3, shape: EarthShape) -> Self {
        let unit_position = shape.position_local_to_unit(world_position);

        Self::from_unit_position(unit_position, shape.is_spherical())
    }

    pub fn local_position(self, shape: EarthShape, height: f32) -> DVec3 {
