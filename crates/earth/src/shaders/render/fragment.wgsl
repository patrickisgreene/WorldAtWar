#define_import_path waw_earth::fragment

#import waw_earth::types::{Blend, Coordinate, WorldCoordinate, AtlasTile, TangentSpace}
#import waw_earth::bindings::{earth, earth_view, geometry_tiles, approximate_height}
#import waw_earth::functions::{compute_coordinate, compute_world_coordinate, compute_blend, compute_tangent_space, lookup_tile, apply_height, high_precision}
#import waw_earth::attachments::{sample_height_mask, sample_surface_gradient}
#import waw_earth::debug::{show_data_lod, show_geometry_lod, show_tile_tree, show_pixels}
