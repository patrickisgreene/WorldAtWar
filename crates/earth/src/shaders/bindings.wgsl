#define_import_path waw_earth::bindings

#import waw_earth::types::{EarthView, Earth, TileTreeEntry, TileCoordinate, GeometryTile, AttachmentConfig, EarthModelApproximation, IndirectBuffer, PrepassState}
