#define_import_path waw_earth::functions

#import waw_earth::attachments::compute_sample_uv
#import waw_earth::types::AttachmentConfig
#import waw_earth::bindings::{earth, earth_sampler, origins, earth_view, geometry_tiles, tile_tree, view, approximate_height}
#import waw_earth::types::{TileCoordinate, WorldCoordinate, TileTree, TileTreeEntry, AtlasTile, Blend, BestLookup, Coordinate, Morph, TangentSpace}
