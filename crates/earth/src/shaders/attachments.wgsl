#define_import_path waw_earth::attachments

#import waw_earth::types::{AtlasTile, TangentSpace, AttachmentConfig, SampleUV, WorldCoordinate}
#import waw_earth::bindings::{earth, earth_view, earth_sampler, attachments, topography_attachment}
